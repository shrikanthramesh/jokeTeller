...
const tellMeJokeButton = document.getElementById("tellMeJoke");
...
function tellMeJoke(joke) {
  VoiceRSS.speech({
    key: "1c8a9b1e3a2e471f87b350adbc40bec8",
    src: `${joke}`,
    hl: "en-us",
    v: "Linda",
    r: 0,
...
async function getJoke() {
  ...
  try {
    ...
    tellMeJoke(this.joke);
  } catch (error) {}
}

tellMeJokeButton.addEventListener("click", getJoke);
